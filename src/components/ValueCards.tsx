...
export default function ValueCards() {
  ...
  return (
    <section className="w-full py-16 px-6 bg-[#F2F2FD] relative z-10">
          ...
          {cards.map((card, index) => (
            <AnimateOnScroll key={card.title} delay={index * 0.1}>
              ...
              >
                ...
                <Link
                  href={card.href}
                  className="inline-flex items-center gap-1.5 text-clause-intelligence font-medium text-sm transition-all duration-300 group-hover:gap-2.5"
                >
